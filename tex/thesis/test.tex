...
\subsection{評価音声}
本稿では、2つのデータセットを用いる。\par
\vspace{0.2in}\noindent{\textbf{\underline{データセット1}}}\par
音源識別精度の検証のために\ref{section:detail_train_news}節で示した「音声」「背景雑音」「音楽」の音源ラベルが付与されているニュース番組13番組分を用いる。\par

\vspace{0.2in}\noindent{\textbf{\underline{データセット2}}}\par
アンカーの発話区間検出、音声認識精度の検証に、「音声」の音源ラベルと発話の書き起こしが付与されているニュース番組5番組分を用いる。データセット2の詳細を表\ref{table:test_detail}に示す。
