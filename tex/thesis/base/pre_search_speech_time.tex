...
表\ref{table:search_table_ap}が得られると$P$（Precision）と$R$(Recall）、F-measure(PrecisionとRecallの調和平均)は式\ref{calc:precision_ap}と式\ref{calc:recall_ap}、式\ref{calc:fmeasure_ap}のようにそれぞれ計算する。
