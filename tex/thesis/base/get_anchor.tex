...
%----- recall -----
      ...
      \begin{minipage}{0.40\hsize}
        \centering
          \subfigure[Recall]{\includegraphics[keepaspectratio, scale=0.45]
...
%----- precision -----
      ...
      \begin{minipage}{0.40\hsize}
        \centering
          \subfigure[Precision]{\includegraphics[keepaspectratio, scale=0.45]
...
%----- fmeasure -----
      ...
      \begin{minipage}{0.40\hsize}
        \centering
          \subfigure[F-measure]{\includegraphics[keepaspectratio, scale=0.45]
                          {./figure/result_kmeans_f.eps} \label{baseline_fmeasure}}
      \end{minipage}
    ...
    \end{tabular}
\caption{Baseline1による発話区間検出精度 \label{fig:result_anchor_baseline}}
\end{figure} 


\begin{table}[H]
  \begin{center}
    \caption{Baseline1による各ニュース番組音声のニュースアンカーの発話検出精度(クラスタの個数=14) \label{table:baseline_eachnews}}
...
%----- fmeasure -----
      ...
      \begin{minipage}{0.40\hsize}
        \centering
          \subfigure[F-measure]{\includegraphics[keepaspectratio, scale=0.45]
                          {./time/figure/result_time_f.eps} \label{baseline_fmeasure}}
      \end{minipage}
    ...
    \end{tabular}
\caption{Baseline1による発話区間検出精度 \label{fig:result_anchor_baseline_time}}
\end{figure} 


\begin{table}[H]
  \begin{center}
    \caption{Baseline1による各ニュース番組音声のニュースアンカーの発話検出精度(クラスタの個数=17) \label{table:baseline_eachnews}}
    \begin{tabular}{|c||c|c|c|c|} \hline
データID & Recall & Precision & F-meature & 作成したクラスタ数\\ \hline
ニュース1 & 0.818 & 0.634 & 0.714 & 9\\ \hline
ニュース1 & 0.915 & 0.376 & 0.533 & 13\\ \hline
ニュース1 & 0.966 & 0.537 & 0.690 & 13\\ \hline
ニュース1 & 0.776 & 0.545 & 0.640 & 11\\ \hline
ニュース1 & 0.829 & 0.680 & 0.747 & 11\\ \hline
計 & 0.904 & 0.630 & 0.742\\ \hline
    \end{tabular}
  \end{center}
\end{table}
...
%----- fmeasure -----
    ...
    \end{tabular}
\caption{Baseline2による発話区間検出精度}
\end{figure} 


\begin{table}[H]
  \begin{center}
    \caption{Baseline2による各ニュース番組音声のニュースアンカーの発話検出精度($Th_{cos}=0.5$) \label{table:baseline_eachnews_time}}
    \begin{tabular}{|c||c|c|c|c|} \hline
データID & Recall & Precision & F-meature & 作成したクラスタ数\\ \hline
ニュース1 & 0.992 & 0.705 & 0.824 & 1 \\ \hline
ニュース2 & 0.748 & 0.591 & 0.66 & 2 \\ \hline
...
ニュース2 & 0.772 & 0.809 & 0.79 & 2 \\ \hline
...
\begin{table}[H]
  \begin{center}
    ...
    \begin{tabular}{|c||c|c|c|c|} \hline
データID & Recall & Precision & F-meature & 作成したクラスタ数\\ \hline
ニュース1 & 0.981 & 0.689 & 0.81 & 1 \\ \hline
